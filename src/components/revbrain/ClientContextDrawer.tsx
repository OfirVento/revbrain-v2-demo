...
export const CLIENT_INQUIRIES: ClientInquiry[] = [
  {
    ...
    impactLabel: '23% below policy · 14–18% margin · ≈$370K modeled annual margin exposure',
    ...
    revbrainFinding: {
      summary: 'Documented policy sets a 20% margin floor, but 23% of observed quotes were approved at 14–18% margin through manual overrides.',
      ...
      impact: 'Modeled ≈$370K annual margin exposure if pricing thresholds are not enforced deterministically.',
    },
    questionSent: {
      channel: 'Email',
