...
export const CLIENT_INQUIRIES: ClientInquiry[] = [
  ...
  },
  {
    ...
    revbrainFinding: {
      summary: 'Two senior managers manually review almost every approval despite a 98.4% approval rate.',
  ...
  },
  {
    ...
    impactLabel: '4.6% of renewals affected · ≈$315K modeled annual revenue leakage',
    statusLabel: 'Needs RevOps validation',
    owner: {
      name: 'David Kim',
      role: 'Deal Desk Lead',
      avatarInitials: 'DK',
    ...
    latestInteraction: {
      channel: 'Slack',
      timeAgo: '6h ago',
      summary: 'Client replied via Slack · Needs RevOps validation',
    },
    revbrainFinding: {
      summary: 'Contracted renewal uplift terms are not consistently applied across multi-year renewals.',
      evidence: '64 enterprise subscription contracts contain custom contract terms (Contract_Uplift_Cap__c = 5.0) that deviate from automated renewal execution.',
    ...
    questionSent: {
      ...
      questionText: 'How should contracted renewal uplift terms on legacy multi-year contracts be deterministically enforced in Revenue Cloud?',
      isDraft: false,
    },
    clientResponse: {
      author: 'David Kim',
  ...
  },
  {
    ...
    impactLabel: '2.7% of quotes affected · ≈$240K modeled annual revenue leakage',
    statusLabel: 'Needs SalesOps validation',
    owner: {
      name: 'Elena Rostova',
    ...
    latestInteraction: {
      channel: 'Slack',
      timeAgo: '3h ago',
      summary: 'Asked via Slack · Waiting on SalesOps response',
    },
    revbrainFinding: {
      summary: 'Account-specific pricing is not consistently applied when quotes are created outside the standard quoting path.',
      evidence: 'Telemetry identified quotes generated via custom clone paths bypassing contracted price books.',
      impact: '2.7% of quotes affected · ≈$240K modeled annual revenue leakage',
    },
    questionSent: {
      channel: 'Slack',
      sentAt: 'Today, 10:15 AM',
      targetRecipient: 'Elena Rostova (#salesops)',
    ...
    materials: [
      {
        id: 'm9',
        name: 'Contracted Pricing Matrix.xlsx',
        type: 'sheet',
        area: 'Pricing',
        sizeOrCount: '1.4 MB',
        updatedAt: 'Today',
        snippet: 'Customer-specific contracted schedule agreements and floor discount overrides',
      },
    ],
  },
  {
    ...
    revbrainFinding: {
      summary: 'Strategic accounts appear to bypass the standard pricing and approval path in several observed cases.',
  ...
  },
  {
    ...
    revbrainFinding: {
      summary: 'Approved quotes can be repriced without re-running the full approval path.',
