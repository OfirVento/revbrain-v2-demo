...
const PRIMARY_ATTENTION_ITEMS: AttentionItem[] = [
  {
    ...
    impact: 'Impact: 11.4K approvals · ~4,560 hrs/yr · ≈$410K annual effort',
  ...
  },
  {
    ...
    impact: 'Impact: 23% below policy · 14–18% observed margin · ≈$370K modeled annual margin exposure',
  ...
  },
  {
    ...
    impact: 'Impact: 4.6% of renewals affected · ≈$315K modeled annual revenue leakage',
  ...
  },
  {
    ...
    impact: 'Impact: 2.7% of quotes affected · ≈$240K modeled annual revenue leakage',
  ...
  },
  {
    ...
    impact: 'Impact: Strategic-account exceptions observed · ≈$185K modeled annual revenue exposure',
  ...
  },
  {
    ...
    impact: 'Impact: Post-approval repricing observed · ≈$160K modeled annual pricing exposure',
...
const EXTRA_ATTENTION_ITEMS: AttentionItem[] = [
  {
    ...
    impact: 'Impact: 150+ line item quotes affected · ~180 hrs/yr · ≈$16K annual effort',
  ...
  },
  {
    ...
    impact: 'Impact: 320 cross-border invoices · ~120 hrs/yr · ≈$11K annual effort',
