                        ...
                        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-4 md:gap-[6px] items-stretch">
                          ...
                          <div className="rounded-xl border border-[#D5D0C8] bg-[#FAF9F7] p-4 flex flex-col justify-between space-y-3">
                            <div className="space-y-1">
                              <h4 className="text-[10px] font-bold uppercase tracking-wider text-[#3D3929] border-b border-[#D5D0C8] pb-2 mb-3 flex items-center justify-center gap-2 text-center">
                                <span className="shrink-0">Current approval process</span>
                                <span className="text-[#8A8578] font-normal shrink-0">·</span>
                                <span className="text-[10px] font-bold uppercase tracking-wider text-slate-900 shrink-0">
                          ...
                          <div className="rounded-xl border border-[#C5BFD6] bg-[#F9F8FC] p-4 flex flex-col justify-between space-y-3">
                            <div className="space-y-1">
                              <h4 className="text-[10px] font-bold uppercase tracking-wider text-[#3D3929] border-b border-[#C5BFD6] pb-2 mb-3 flex items-center justify-center gap-2 text-center">
