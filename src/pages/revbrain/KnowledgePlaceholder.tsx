  ...
  return (
    <div className="w-full flex flex-col min-h-[calc(100vh-140px)] bg-slate-100/60 text-slate-800 font-sans">
      <div className="max-w-[1440px] mx-auto w-full px-6 pt-5 pb-20 space-y-4 flex-1">
        ...
        {/* ────────────────────────────────────────────────────────────── */}
        {screen === 4 && (
          <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-2xs space-y-4 animate-[fadeIn_300ms_ease]">
            ...
            {/* 3 Horizontal Connected Progression Cards (Consistent Colors & High Density) */}
            <div className="flex flex-col md:flex-row items-center gap-3">
              
              {/* Implementation #1 */}
              <div className="flex-1 w-full bg-white border border-slate-200/90 p-3.5 rounded-xl space-y-2 shadow-2xs">
                <div className="flex items-center justify-between">
                  <span className="text-[11px] font-bold text-slate-500 font-mono uppercase tracking-wide">Implementation #1</span>
              ...
              <ChevronRight className="hidden md:block w-4 h-4 text-slate-400 shrink-0" />

              {/* Implementation #6 */}
              <div className="flex-1 w-full bg-violet-50/80 border border-violet-200/80 p-3.5 rounded-xl space-y-2 shadow-2xs">
                <div className="flex items-center justify-between">
                  <span className="text-[11px] font-bold text-violet-700 font-mono uppercase tracking-wide">Implementation #6</span>
                  <span className="text-[10px] font-mono font-semibold text-violet-800 bg-violet-100/80 px-2 py-0.5 rounded border border-violet-300/80">
                    Accelerating
                  </span>
                </div>
                <div className="flex items-baseline justify-between gap-2">
              ...
              <ChevronRight className="hidden md:block w-4 h-4 text-violet-400 shrink-0" />

              {/* Implementation #12 */}
              <div className="flex-1 w-full bg-emerald-50/80 border border-emerald-200/80 p-3.5 rounded-xl space-y-2 shadow-2xs">
                <div className="flex items-center justify-between">
                  <span className="text-[11px] font-bold text-emerald-800 font-mono uppercase tracking-wide">Implementation #12</span>
            ...
            {/* ── High-Density 4-KPI Summary Strip ─────────────────────────────── */}
            <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-3.5 space-y-2.5">
              <div className="flex items-center justify-between">
                <h3 className="text-xs font-bold text-slate-900 uppercase tracking-wide">
                  Observed Impact Across Q2C Workflows
                </h3>
                <span className="text-[11px] font-mono text-slate-500">
                  ~1,350 hrs before RevBrain &rarr; ~523 hrs with RevBrain
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5">
                ...
                <div className="bg-white border border-slate-200 rounded-lg p-2.5 shadow-2xs">
                  <span className="text-[10px] font-medium text-slate-500 uppercase tracking-wide">Quarterly Savings</span>
                  <p className="text-base font-black text-slate-900 mt-0.5">~827 hrs / qtr</p>
                  <p className="text-[10px] font-mono text-emerald-600 font-semibold mt-0.5">61% less manual effort</p>
                </div>

                {/* Metric 2 */}
                <div className="bg-white border border-slate-200 rounded-lg p-2.5 shadow-2xs">
                  <span className="text-[10px] font-medium text-slate-500 uppercase tracking-wide">Effort Reduction</span>
                  <p className="text-base font-black text-emerald-700 mt-0.5">61% Less Effort</p>
                  <p className="text-[10px] text-slate-500 mt-0.5">Total SI &amp; RevOps workload</p>
                </div>

                {/* Metric 3 */}
                <div className="bg-white border border-slate-200 rounded-lg p-2.5 shadow-2xs">
                  <span className="text-[10px] font-medium text-slate-500 uppercase tracking-wide">Reusable Assets</span>
                  <p className="text-base font-black text-violet-900 font-mono mt-0.5">24 &rarr; 32</p>
                  <p className="text-[10px] text-violet-700 font-medium mt-0.5">Active components</p>
                </div>

                {/* Metric 4 */}
                <div className="bg-white border border-slate-200 rounded-lg p-2.5 shadow-2xs">
                  <span className="text-[10px] font-medium text-slate-500 uppercase tracking-wide">Mapping Confidence</span>
                  <p className="text-base font-black text-emerald-700 font-mono mt-0.5">81% &rarr; 96%</p>
                  <p className="text-[10px] text-emerald-600 font-medium mt-0.5">+15% automated accuracy</p>
                </div>
              </div>
            </div>

            {/* ── Observed Impact by Workflow ──────────────────────────────────── */}
            <div className="space-y-2.5 pt-1">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[11px] font-mono text-slate-500">
                  Quarterly manual effort reduction
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5">
                ...
                {/* Discount Approvals */}
                <div className="bg-white border border-slate-200/90 rounded-xl p-3 shadow-2xs space-y-1.5 hover:border-violet-300 transition-all">
                  <div className="flex items-center justify-between">
                  ...
                  <p className="text-base font-black font-mono text-slate-900">340 &rarr; 88 hrs/qtr</p>
                  <p className="text-[10px] text-slate-500">Pre-built approval agents &amp; policy rules</p>
                </div>
                ...
                <div className="bg-white border border-slate-200/90 rounded-xl p-3 shadow-2xs space-y-1.5 hover:border-violet-300 transition-all">
                  ...
                  <p className="text-base font-black font-mono text-slate-900">420 &rarr; 170 hrs/qtr</p>
                  <p className="text-[10px] text-slate-500">Automated discount matrix validation</p>
                </div>
                ...
                <div className="bg-white border border-slate-200/90 rounded-xl p-3 shadow-2xs space-y-1.5 hover:border-violet-300 transition-all">
                  ...
                  <p className="text-base font-black font-mono text-slate-900">310 &rarr; 125 hrs/qtr</p>
                  <p className="text-[10px] text-slate-500">Continuous contract-to-order sync</p>
                </div>

              </div>

              {/* Expandable 5 Additional Q2C Areas */}
              {showExtraCompounding && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2.5 pt-1 animate-[fadeIn_200ms_ease]">
                  
                  {/* Renewals & Amendments */}
                  <div className="bg-slate-50 border border-slate-200/90 rounded-xl p-3 shadow-2xs space-y-1.5">
                    <div className="flex items-center justify-between">
                  ...
                  <div className="bg-slate-50 border border-slate-200/90 rounded-xl p-3 shadow-2xs space-y-1.5">
                    <div className="flex items-center justify-between">
                      <h4 className="text-xs font-bold text-slate-900">Bundle / Product Config</h4>
                      <span className="text-[10px] font-mono font-bold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200">
                        36% fewer rework
                      </span>
                    </div>
                  ...
                  <div className="bg-slate-50 border border-slate-200/90 rounded-xl p-3 shadow-2xs space-y-1.5">
                    ...
                    <p className="text-[10px] text-slate-500">Pre-populated opportunity line items</p>
                  </div>
              ...
              <div className="pt-1">
                <button
                  ...
                  className="text-xs font-semibold text-slate-900 bg-slate-100 hover:bg-slate-200 border border-slate-200 px-3.5 py-1.5 rounded-full transition-colors cursor-pointer flex items-center gap-1.5"
                >
                  <span>{showExtraCompounding ? 'Show fewer Q2C areas' : '+ Show 5 more Q2C areas'}</span>
